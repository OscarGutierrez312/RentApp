      ...
      <LayoutCatalogue>
        <div className="flex flex-col justify-center my-20 bg-blend-color">          
          <div className="flex justify-center m-10">
            <div className="flex flex-col min-w-full min-h-fit max-h-[550px] md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg ring-2  ">
              <img className=" w-full h-96 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" src="/images/bici_1.jpg" alt="" />
              <div className="p-6 flex flex-col justify-start">
                <h5 className="text-gray-900 text-xl font-medium mb-2">Bicicleta 1</h5>
                <p className="text-gray-700 text-base mb-4 text-sm">
                ...
                <p className="text-gray-600 text-xs"> mins ago</p>
