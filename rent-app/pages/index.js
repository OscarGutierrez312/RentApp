    ...
    <ColorProvider value={color}>
      ...
      <div className="z-auto m-2 divide-y-4 divide-black-200 divide-solid" >
        ...
        <div className="text-center  p-20 px-6 mb-9 ">
            ...
            md:text-7xl
            lg:text-8xl
            mt-0 mb-6 text-[#98c8eb] hover:text-[#4a65eb] transition duration-150 ease-in-out" data-testid="title">
                Bienvenido a EasyCar</h1>
             
            <h3 className="text-2xl font-thin mb-8 italic" data-testid="subtitle">
                Pide o Arrienda cualquiera de 
            los tipos de vehiculos disponibles</h3>
        </div>
        <h1 className="px-40 pt-10 text-4xl text-yellow-700 hover:scale-105 transition duration-150 ease-in-out" data-testid="description">Busca un Vehículo por tu Marca Favorita,
        ...
        <div className="grid grid-cols-2 pr-52 pl-52 pb-52">
          <Link href="/info/manual">
              <div className="col-span-2" data-testid="manual">
          ...
          <Link href="/info/seguros">
            <div className="col-span-2" data-testid="seguro">
          ...
          <Link href="/User/comments">
            <div className="col-span-2" data-testid="comments">
